...
function CreateAllBurnCards()
{
	...
	CreateBurnCardWeapon( "bc_twinb_m2",						BURNCARD_COMMON, 	BCGROUP_WEAPON, 	CT_WEAPON	| CT_SMG							, "burncards/amped_twinb",		BC_NEXTDEATH, 		"#BC_TWINB_M2"				, "#BC_TWINB_M2_DESC"			, "#BC_TWINB_M2_FLAVOR"					, "#BC_FLAVOR_SKYFISH",			"mp_weapon_mega2",			"burn_mod_twinb",							"SIDEARM"		)
