...
function InitOptionsMenu( menu )
{
	...
	AddEventHandlerToButtonClass( menu, "HudSettingsButtonClass", UIE_CLICK, AdvanceMenuEventHandler( GetMenu( "HudSettingsMenu" ) ) )
	AddEventHandlerToButtonClass( menu, "HudSettingsButtonClass", UIE_GET_FOCUS, HudSettings_Focused )
}
