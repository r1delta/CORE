function main()
{
	local DESTROYER_MODEL = "models/titans/destroyer/destroyer_titan.mdl"

	ModelFX_BeginData( "titanHealth", DESTROYER_MODEL, "notLocalPlayer", true )
	...
	ModelFX_BeginData( "titanDoomed", DESTROYER_MODEL, "notLocalPlayer", false )
	...
	ModelFX_BeginData( "titanDamage", DESTROYER_MODEL, "notLocalPlayer", true )
