...
function main()
{
	...
	SetGameModeAnnouncement( "GameModeAnnounce_LTS" )

	AddCallback_OnPlayerRespawned( LTS_OnPlayerRespawned ) //!ky 리스폰 테스트용

	AddCallback_GameStateEnter( eGameState.Prematch, BBPrematchStart )
	AddCallback_GameStateEnter( eGameState.SwitchingSides, BBSwitchingSidesEnter )
	AddCallback_GameStateEnter( eGameState.Playing, BBPlayingStart )
	AddCallback_GameStateEnter( eGameState.WinnerDetermined, BBWinnerDeterminedStart )
